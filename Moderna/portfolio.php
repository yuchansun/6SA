  ...
  * License: https://bootstrapmade.com/license/
  ...
  <style>
    .portfolio-flters {
      ...
      gap: 15px;
      /* Adds space between the filter buttons */
      margin: 20px 0;
      /* Optional: Adds top and bottom margin for spacing */
    }
    ...
    .portfolio-info {
      ...
      /* Move the buttons out of view initially */
      transition: opacity 0.3s ease, transform 0.3s ease;
      /* Transition for visibility and position */
    }
    ...
    .portfolio-info a:hover {
      ...
      transform: scale(1.2);
      /* Scale the buttons when hovered */
      font-size: 16px;
    ...
    .portfolio-content:hover .portfolio-info {
      opacity: 1;
      /* Show the buttons when hovering over the image */
      transform: translateY(0);
      /* Bring the buttons into view */
    }

    .portfolio-content:hover img {
      transform: scale(1.1);
      /* Optionally, scale the image slightly on hover */
    }
