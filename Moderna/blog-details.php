...
<style>
  ...
  .role {
    font-style: italic;
    color: rgb(42, 120, 126);
    /* 橘色 */
    font-size: 0.85em;

    border-radius: 4px;
    padding: 2px 4px;
    background-color: rgb(122, 201, 221);
    /* 淡橘背景 */
  }
</style>
            ...
            <section id="blog-posts" class="blog-posts section">
              <div class="container">
                <?php while ($post = $postsResult->fetch_assoc()): ?>
                  ...
                  <img src="<?= htmlspecialchars(!empty($post['Photo']) && file_exists($post['Photo']) ? $post['Photo'] : 'assets/img/personal_photo/default.jpeg') ?>"
                      alt="頭像"
